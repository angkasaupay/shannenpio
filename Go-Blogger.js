 ...
 *
 * Script For ShannenPio Cloning Blogger By Shannenpio - ShannenPio.blogspot.com
*/
...
(function(md) {
    ...
    md(function() {
      ...
      if(!("dihak"==secretBlog&&window.location.href.indexOf(urlBlog)>-1)&&notload){
      	md('<div class="ads" style="margin-bottom: 20px;border-radius: 5px;overflow: hidden;box-shadow: 0 3px 1px rgba(0,0,0,0.16),0 3px 6px rgba(0,0,0,0.23);display: inherit;height: 250px;"><a href="http://www.shannenpio.blogspot.com/" target="_blank" title="Tutorial Blogger | shannen pio"><img alt="shannenpio" src="https://sites.google.com/site/gudangranda/bg/iklan%20shannenpio.png"></a><span class="iklan-shannenpio" style="display: none;background:#d3d3d3;width:100px;height:15px;border-bottom-left-radius:4px;position:absolute;top:0;right:0;color:#000;font:normal 11px Arial,Sans-Serif;text-align:left;overflow:hidden;padding-right:19px;display: none;">Iklan oleh ShannenPio</span><span class="info-icon" style="width:15px;height:15px;position:absolute;top:0;right:0;cursor:pointer"><a href="http://www.shannenpio.blogspot.com/p/pasang-iklan.html" target="_blank"><img alt="info" src="http://2.bp.blogspot.com/--ivaHIgXThk/UnJWU80FLhI/AAAAAAAAF_Y/WrH-8aYijGw/s1600/iklan-shannenpio.png" style="vertical-align: top;"></a></span></div>').insertBefore('#sidebar-atas');
      	...
      	if (md('#creditmd').html()!=('Template By <a href="http://www.shannenpio.blogspot.com/" target="_blank" title="ShannenPio Cloning">shannenpio</a>')) {
      		location.href="http://www.shannenpio.blogspot.com"
      	};
      	notload=false;
      }
    });
	...
	md(function() {
      ...
      if(!("dihak"==secretBlog&&window.location.href.indexOf(urlBlog)>-1)&&notload){
      	...
      	md('#creditmd').css({display:"initial","font-size": "100%",color: "#fff",visibility: "visible"})
      	if (md('#creditmd').html()!=('Template By <a href="http://www.shannenpio.blogspot.com/" target="_blank" title="ShannenPio Cloning">shannenpio</a>')) {
      		location.href="http://www.shannenpio.blogspot.com.com"
      	};
      	notload=false;
      }
    });
